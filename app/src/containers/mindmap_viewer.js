...
export default class MindmapViewer extends Component {
    ...
    index_next_depth(data, idx, depth){
        ...
        console.log("testing index next depth")
        ...
        for(var i=idx; i<data.length; i++){
            ...
            if (current_depth < depth){
                console.log("Depth Change at:", line);
                console.log("Depth Change idx:", i);
                return i;
            }
        }
        return data.length;
    ...
    add_to_node(parent_node, depth, data){
        ...
        for (var i=0; i<data.length; i++){
            ...
            if (current_depth == depth+1){
                ...
                console.log(i_next);
                console.log(data.slice(i, i_next));
    ...
    render() {
        ...
        console.log(this.props.mindmapData);
